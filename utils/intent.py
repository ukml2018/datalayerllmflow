...
def ll_helper_rules():
    ...
    rules.append("To find the n top performing SKUs for the microregion for the outlet mentioned in the question, follow these steps: 1. Find the microregion of the outlet mentioned in the question; 2. Find the power rank for all SKUs in the microregion and sort the SKUs in the descending order of power rank; 3. Find the top n SKUs from the sorted SKUs.")
    rules.append("To find the n top performing SKUs for the outlet mentioned in the question, follow these steps: 1. Find all SKU's in the outlet mentioned in the question; 2. find the Measure Umsatz for all SKUs in the outlet and sort the SKUs in the descending order of Measure Umsatz; 3. find the top n SKUs from the sorted SKUs.")  
    return rules
